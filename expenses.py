...
HELP_TEXT = (
    ...
    "• /delete ID - delete receipt with ID (you can only delete your own receipts)\n"
    ...
    "\nAdmin-only commands:\n"
    "• /delete ID - admins can delete ANY receipt for moderation\n"
    ...
    "🔒 Security: Users can only delete their own receipts. Admins can delete any receipt for moderation purposes.\n"
